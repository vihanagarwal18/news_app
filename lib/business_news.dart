/*
https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=3bc376ffe7874e589d054ad1cd22a58e
 */
...
class _businessState extends State<business> {
  ...
  void initState() {
    super.initState();
    futureArticles = getbusinessNews();
  }

  Future<List<Articlemodel>> getbusinessNews() async {
    print('fetching data started');
    var response = await http.get(Uri.parse("https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=3bc376ffe7874e589d054ad1cd22a58e"));
