/*
https://newsapi.org/v2/top-headlines?country=in&category=health&apiKey=3bc376ffe7874e589d054ad1cd22a58e
 */
...
class _healthState extends State<health> {
  ...
  void initState() {
    super.initState();
    futureArticles = gethealthNews();

  }

  Future<List<Articlemodel>> gethealthNews() async {
    print('fetching data started');
    var response = await http.get(Uri.parse("https://newsapi.org/v2/top-headlines?country=in&category=health&apiKey=3bc376ffe7874e589d054ad1cd22a58e"));
