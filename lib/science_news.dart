/*
https://newsapi.org/v2/top-headlines?country=in&category=science&apiKey=3bc376ffe7874e589d054ad1cd22a58e
 */
...
class _scienceState extends State<science> {
  ...
  void initState() {
    super.initState();
    futureArticles = getscienceNews();
  }

  Future<List<Articlemodel>> getscienceNews() async {
    print('fetching data started');
    var response = await http.get(Uri.parse("https://newsapi.org/v2/top-headlines?country=in&category=science&apiKey=3bc376ffe7874e589d054ad1cd22a58e"));
