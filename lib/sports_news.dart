...
class _sportState extends State<sport> {
  ...
  void initState() {
    super.initState();
    futureArticles = getsportNews();
  }

  Future<List<Articlemodel>> getsportNews() async {
    print('fetching data started');
    var response = await http.get(Uri.parse("https://newsapi.org/v2/top-headlines?country=in&category=sports&apiKey=3bc376ffe7874e589d054ad1cd22a58e"));
