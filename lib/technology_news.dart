/*
https://newsapi.org/v2/top-headlines?country=in&category=technology&apiKey=3bc376ffe7874e589d054ad1cd22a58e
 */
...
class _technologyState extends State<technology> {
  ...
  void initState() {
    super.initState();
    futureArticles = gettechnologyNews();
  }

  Future<List<Articlemodel>> gettechnologyNews() async {
    print('fetching data started');
    var response = await http.get(Uri.parse("https://newsapi.org/v2/top-headlines?country=in&category=technology&apiKey=3bc376ffe7874e589d054ad1cd22a58e"));
